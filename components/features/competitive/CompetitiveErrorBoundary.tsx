    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="rounded-xl border border-red-900/40 bg-red-950/20 p-6 text-center space-y-2">
          <p className="text-sm font-medium text-red-400">Competitive analysis failed to render</p>
          <p className="text-xs text-zinc-500 max-w-sm mx-auto">{this.state.message || 'An unexpected error occurred. Try refreshing the page.'}</p>
          <button
